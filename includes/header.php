...
<header class="header-v4">
        ...
        <div class="wrap-menu-desktop how-shadow1">
            <nav class="limiter-menu-desktop container">
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        <li>
                            <a href="index.php?p=home" class="<?= ($currentPage == 'home' ? 'active' : '') ?>">Home</a>
                        </li>
                        <li>
                            <a href="index.php?p=shop" class="<?= ($currentPage == 'shop' ? 'active' : '') ?>">Shop</a>
                        </li>
                        <li>
    ...
    <div class="wrap-header-mobile">
        ...
        <div class="logo-mobile">
            <a href="index.php?p=home"><img src="images/icons/logo-01.png" alt="IMG-LOGO"></a>
        </div>
    ...
    <div class="menu-mobile">
        ...
        <ul class="main-menu-m">
            ...
            <li>
                <a href="index.php?p=contact" class="<?= ($currentPage == 'contact' ? 'active' : '') ?>">Contact</a>
            </li>
        </ul>
    </div>
